...
def garry_statistics():
    ...
    conn_src.close()
    # write the rusults
    fw = open("statistics_0630new.data","w")
    ...
    for topic1, topic1_value in topic1_account_openid_subtopic_1_num.items():
        ...
        for key, key_value in subtopic_1_value_sort:
            ...
            topic1 = key_eles[2]
            sutopic_1 = key_eles[3]
            #print account_openid,topic1,sutopic_1
