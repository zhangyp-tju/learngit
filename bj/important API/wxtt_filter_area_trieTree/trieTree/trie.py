...
class Dict (Trie): # 继承自class类Trie
    def __init__(self, fname):
        starttime = time.time()
        print "START LOAD...From [%s]" % (fname)
        super (Dict, self).__init__()
        self.load(fname)
        endtime = time.time()
        print "END LOAD...COST %s sec" % (endtime - starttime)

    def load(self, fname):
        file = codecs.open(fname, 'r', 'gbk')
        for line in file:
            word = line.strip()
            self.add(word, word) # 加载文件add()
        file.close()
...
if __name__ == "__main__":
        ...
        for x in range(1):
            starttime = time.time()
            test_str = u"zyp , zyp,zyp大庆让胡路喇嘛甸哪里有找小姐服务１８６－５５５５－２５５７娜娜【ＱＱ１９６８４５４６８８空间选小姐】哪里有小姐服务１８６－５５５５－２５５７【ＱＱ１９６８４５４６８８空间选小姐】哪里有小姐服务１８６－５５５５－２５５７娜娜【ＱＱ１９６８４５４６８８空间看照片】无论朋友你常住本市。。 哪里找小姐服务娜娜【１８６－５５５５－２５５７娜娜】还是阁下才来我市。这些都不重要。。哪里找小姐服务１８６－５５５５－２５５７娜娜因为找我们在寂寞的深夜你不在感到孤单和寂寞。。易天"
