...
def checkUrl(requestArray,idxArray, lock):
    ...
    while(1):
        ...
        #if  'è¯¥å†…å®¹å·²è¢«å‘å¸ƒè€…åˆ é™¤' in html.decode('utf8','ignore').encode('gbk','ignore'):
        lock.acquire()
...
def getUrls(openid_file,tmpfile):
    ...
    print >> sys.stderr,"test...ÖÐÎÄÂÒÂë£¿"
    return url_list

# python  getOriAccount.py url_name_openid_0824 ²âÊÔÖÐÎÄ
# python getOriAccount.py 111 getOriAccount.data > tmp.result
### ²»ÖªµÀÎªÊ²Ã´£¬¿ØÖÆÌ¨Êä³öÂÒÂë£¬ÖØ¶¨ÏòÊä³öµ½ÎÄ¼þÖÐ£¬Õý³£
